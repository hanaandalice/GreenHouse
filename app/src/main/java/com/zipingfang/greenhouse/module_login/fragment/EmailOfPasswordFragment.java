...
public class EmailOfPasswordFragment extends BaseLazyFragment {
    ...
    protected int getContentViewLayoutID() {
        return R.layout.fragment_email_of_password;
    }
        ...
        RxView.clicks(tv_next)
                ...
                .subscribe(new Action1<Void>() {
                    ...
                    public void call(Void aVoid) {
                        if (!IsMobilieNum.isEmail(et_email.getText().toString())) {
                            Toast.create(getActivity()).show("输入正确的邮箱");
                            return;
                        }
        ...
        tv_send_code.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (TextUtils.isEmpty(  et_email.getText().toString())) {
                    Toast.create(getActivity()).show("输入邮箱");
                    return;
                }
                num=60;
                timeCount.start();
