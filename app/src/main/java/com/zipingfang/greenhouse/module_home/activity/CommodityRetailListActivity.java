...
public class CommodityRetailListActivity extends TitleBarActivity implements PtrHandler, BaseQuickAdapter.RequestLoadMoreListener {
    ...
    private CommodityRetailAdapter commodityRetailAdapter;
    ...
    protected void initView() throws JSONException, IllegalAccessException {
        ...
        commodityRetailAdapter = new CommodityRetailAdapter(R.layout.item_commodity_retail,this);
        commodityRetailAdapter.setOnLoadMoreListener(this);
        commodityRetailAdapter.setEnableLoadMore(true);
        recyclerView.setAdapter(commodityRetailAdapter);
        ...
        commodityRetailModelList.add(new CommodityRetailModel());
        commodityRetailAdapter.setNewData(commodityRetailModelList);
        commodityRetailAdapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
            @Override
            public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                goActivity(CommodityRetailDetailsActivity.class);
            }
        });
        commodityRetailAdapter.setShoppingClickListener(new CommodityRetailAdapter.ShoppingClickListener() {
            @Override
            public void onClick() {
