...
public class CollarCouponsDialog  {
    private  DiaLogBuider diaLogBuider;
    public  CollarCouponsDialog(Context context){
        View view = LayoutInflater.from(context).inflate(R.layout.dialog_collar_coupons,null);
