...
import com.zipingfang.greenhouse.module_home.fragment.CommodityRetailDetailsFragment;
...
public class CommodityRetailDetailsActivity extends TitleBarActivity {
    @BindView(R.id.tabs)
    TabLayout tabs;
    ...
    public class MinePagerAdapter extends FragmentPagerAdapter {
        Fragment[] fragments = new Fragment[]{new CommodityRetailDetailsFragment(), new ContentDetailFragment(), new CommodityCommentFragment()};
