...
public class CommodityCommentFlowAdapter extends BaseAdapter implements OnInitSelectedPosition {

    private final Context mContext;
    private List<String> mDataList =new ArrayList<>();
    private int selectedPosition=-1;
    public CommodityCommentFlowAdapter(Context context) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.item_commodity_comment_flow_tab, null);
