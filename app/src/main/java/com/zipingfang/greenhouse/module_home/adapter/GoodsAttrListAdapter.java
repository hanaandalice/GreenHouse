...
public class GoodsAttrListAdapter extends BaseAdapter {
    ...
    private List<GoodsAttrListModel> data;

    public GoodsAttrListAdapter(Context context, List<GoodsAttrListModel> data) {
    ...
    public View getView(final int position, View v, ViewGroup parent) {
        ...
        if (v == null) {
            ...
            myView.tv_attr_list = (TextView) v.findViewById(R.id.tv_attr_list);
        ...
        myView.tv_attr_list.setOnClickListener(new OnClickListener() {
            @Override
