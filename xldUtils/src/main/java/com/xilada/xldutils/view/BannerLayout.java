...
import com.xilada.xldutils.widget.autoscoll.AutoScrollViewPager;
...
public class BannerLayout extends FrameLayout implements ViewPager.OnPageChangeListener {
    ...
    void init(Context context,AttributeSet attrs){
        ...
        autoScrollViewPager.setLayoutParams(new FrameLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT));
        ...
        autoScrollViewPager.setOnItemClickListener(new ClickViewPager.OnItemClickListener() {
            ...
            public void onItemClick(int position) {
                if (null!=bannerItemListener) {
                    bannerItemListener.onItem(position);
                }
            }
        });
...
//        System.err.println("--sizeWidth-->"+sizeWidth);
//        System.err.println("--sizeHeight-->"+sizeHeight);
//        System.err.println("--widthMeasureSpec-->"+widthMeasureSpec);
//        System.err.println("--heightMeasureSpec-->"+heightMeasureSpec);
        if (aspect>0) {
